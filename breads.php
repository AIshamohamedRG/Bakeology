    ...
    <section class="products-section">
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                ...
                <h3>Toast</h3>
                <!-- Product name -->
                <p class="price">110 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Toast', price: 110, image: 'images/toast.jpg' })">Add to Cart</button>
            ...
            <div class="product-card">
                ...
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Sourdough', price: 250, image: 'images/Sourdough.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>

            <div class="product-card">
                <!-- Product card 3 -->
                <img src="images/baguettes.jpg" alt="baguettes">
                <!-- Product image -->
                <h3>Baguettes</h3>
                <!-- Product name -->
                <p class="price">170 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Baguettes', price: 170, image: 'images/baguettes.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
        </div>
    </section>
