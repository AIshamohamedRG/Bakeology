    ...
    <section class="products-section">
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                <!-- Product card 1 -->
                <img src="images/Chocolate Cookie.jpg" alt="Chocolate Cookie">
                <!-- Product image -->
                <h3>Chocolate Cookie</h3>
                <!-- Product name -->
                <p class="price">85 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Chocolate Cookie', price: 85, image: 'images/Chocolate Cookie.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>

            <div class="product-card">
                <!-- Product card 2 -->
                <img src="images/gingerbread cookie.jpg" alt="gingerbread">
                <!-- Product image -->
                <h3>Gingerbread Cookie</h3>
                <!-- Product name -->
                <p class="price">65 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Gingerbread Cookie', price: 65, image: 'images/gingerbread cookie.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>

            <div class="product-card">
                <!-- Product card 3 -->
                <img src="images/Cookie Box.jpg" alt="Cookie Box">
                <!-- Product image -->
                <h3>Cookie Box</h3>
                <!-- Product name -->
                <p class="price">240 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Cookie Box', price: 240, image: 'images/Cookie Box.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
        </div>
    </section>
