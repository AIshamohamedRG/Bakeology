    ...
    <section class="products-section">
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                <!-- Product card 1 -->
                <img src="images/Danish pastry.jpg" alt="Danish pastry">
                <!-- Product image -->
                <h3>Danish Pastry</h3>
                <!-- Product name -->
                <p class="price">90 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Danish Pastry', price: 90, image: 'images/Danish pastry.jpg' })">Add to Cart</button>
            ...
            <div class="product-card">
                ...
                <h3>Croissant</h3>
                <!-- Product name -->
                <p class="price">55 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Croissant', price: 55, image: 'images/Croissant.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>

            <div class="product-card">
                <!-- Product card 3 -->
                <img src="images/Éclair.jpg" alt="Éclair">
                <!-- Product image -->
                <h3>Éclair</h3>
                <!-- Product name -->
                <p class="price">100 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Éclair', price: 100, image: 'images/Éclair.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
        </div>
    </section>
