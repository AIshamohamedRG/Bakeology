...
<head>
    ...
    <title>Desserts - Bakeology</title>
    <!-- Changed title to "Desserts" since this appears to be a desserts page -->
...
<body class="login-page">
    ...
    <section class="products-section">
        <!-- Products section -->
        <h2>Our Desserts</h2>
        <!-- Changed heading to "Our Desserts" -->
        <div class="products-container">
            <!-- Container for product cards -->
            <div class="product-card">
                <!-- Product card 1 -->
                <img src="images/Apple crumble.jpg" alt="Apple Crumble">
                <!-- Product image -->
                <h3>Apple Crumble</h3>
                <!-- Product name -->
                <p class="price">150 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Apple Crumble', price: 150, image: 'images/Apple Crumble.jpg' })">Add to Cart</button>
            ...
            <div class="product-card">
                ...
                <h3>Tiramisu</h3>
                <!-- Product name -->
                <p class="price">250 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Tiramisu', price: 250, image: 'images/Tiramisu.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
            ...
            <div class="product-card">
                ...
                <h3>Brownie</h3>
                <!-- Product name -->
                <p class="price">105 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Brownie', price: 105, image: 'images/Brownie.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
        </div>
    </section>
