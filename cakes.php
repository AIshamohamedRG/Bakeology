    ...
    <section class="products-section">
        ...
        <div class="products-container">
            ...
            <div class="product-card">
                ...
                <!-- Product name -->
                <p class="price">500 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Chocolate Cake', price: 500, image: 'images/chocolate Cake.jpg' })">Add to Cart</button>
            ...
            <div class="product-card">
                ...
                <h3>Vanilla Cake</h3>
                <!-- Product name -->
                <p class="price">450 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'Vanilla Cake', price: 450, image: 'images/Vanilla cake.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
            ...
            <div class="product-card">
                ...
                <!-- Product name -->
                <p class="price">550 EG</p>
                <!-- Product price -->
                <button onclick="addToCart({ name: 'strawberry Cake', price: 550, image: 'images/Strawberry Cake.jpg' })">Add to Cart</button>
                <!-- Add to cart button with JavaScript function -->
            </div>
        </div>
    </section>
